...
export class BoardArticleResolver {
    ...
    public async getAllArticlesByAdmin(
        ...
        @AuthMember('_id') memberId: ObjectId ):Promise<BoardArticles> {
        console.log("Query: getAllArticlesByAdmin");
        return await this.boardArticleService.getAllArticlesByAdmin(input);
    }
    ...
    public async updateBoardArticleByAdmin(
        @Args("input") input: BoardArticleUpdate,
        @AuthMember('_id') memberId: ObjectId): Promise<BoardArticle> {
        console.log("Mutation updateBoardArticleByAdmin executed");
        input._id = shapeIntoMongoObjectId(input._id);
    ...
    public async removeBoardArticleByAdmin(@Args("articleId") input: string):Promise<BoardArticle> {
        console.log("Mutation removeBoardArticleByAdmin executed");
        const articleId = shapeIntoMongoObjectId(input);
